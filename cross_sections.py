...
class differential_cross_section:
    def __init__(self, S: float, O3S1OCT: float, O3S1SING: float, O1S0OCT: float, O3P0OCT: float):
        self.S: float = S
    ...
    # cross sections for photon-gluon fusion  
    class PGF:
        def __init__(self, parent):
            self.parent = parent
        ...
        class oct1s0:
            ...
            def U(x, z, Q, PT):
                ...
                pdf = interpolators['g_interp']((x,Q))
